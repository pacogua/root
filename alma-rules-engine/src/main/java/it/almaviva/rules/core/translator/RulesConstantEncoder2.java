...
public class RulesConstantEncoder2 {
	...
	public String getCostantText() {
		return formula;
	}



	public RulesConstantEncoder2(String formula){	
	...
	public String decode(String  costantTextToken) throws RulesException{
