...
public class DateGreatherThanOrEqual extends DateBase {

	public DateGreatherThanOrEqual (){}
	
	public DateGreatherThanOrEqual (String operando1, String operando2, 
	...
	protected ExpressionResult evalueteDateCondition() throws Exception {
		...
		result.setValid(!error);		
	   	...
	   	result.setErrorMessage(buildMessageOperando1() + "deve essere uguale o maggiore"+ buildMessageOperando2());
    	result.setFirstConditionMessage(buildMessageOperando1() +"� maggiore uguale o maggiore"+ buildMessageOperando2());   
	...
	public  String getOperatore() {
		return RulesConstants.OPERATORE_DATE_GREATHER_THAN_OR_EQUAL;
	}
	
	
	@Override
	public ExpressionBase getNewObject() {
		return new DateGreatherThanOrEqual();
	}	
