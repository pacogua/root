...
public class DateLessThanOrEqual extends DateBase {

	public DateLessThanOrEqual (){}
	
	public DateLessThanOrEqual (String operando1, String operando2, 
	...
	protected ExpressionResult evalueteDateCondition() throws Exception {
		...
		result.setValid(!error);		
	   	...
	   	result.setErrorMessage(buildMessageOperando1() + "deve essere uguale o minore"+ buildMessageOperando2());
    	result.setFirstConditionMessage(buildMessageOperando1() +"� uguale o minore"+ buildMessageOperando2());   
	...
	public  String getOperatore() {
		return RulesConstants.OPERATORE_DATE_LESS_THAN_OR_EQUAL;
	}
	

	@Override
	public ExpressionBase getNewObject() {
		return new DateLessThanOrEqual();
	}	
